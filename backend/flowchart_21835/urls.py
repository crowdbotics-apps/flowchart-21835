"""flowchart_21835 URL Configuration
...
admin.site.site_header = "FlowChart"
admin.site.site_title = "FlowChart Admin Portal"
admin.site.index_title = "FlowChart Admin"

# swagger
api_info = openapi.Info(
    title="FlowChart API",
    default_version="v1",
    description="API documentation for FlowChart App",
)
